    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neighbourhood', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hoodie.neighbourhood')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('healthservices', models.ManyToManyField(to='hoodie.healthservices')),
                ('neighbourhood', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hoodie.neighbourhood')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hoodie.blogpost')),
                ('username', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='blogpost',
            name='neighbourhood',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hoodie.neighbourhood'),
        ),
        migrations.AddField(
            model_name='blogpost',
            name='username',
